...
//        swizzle()
        ...
        print(_typeName(_typeByName("7SwiftUI16PreferenceBridgeC")!, qualified: true))
        _forEachField(of: _typeByName("7SwiftUI16PreferenceBridgeC")!, options: [.classType]) { name, offset, type, kind in
            print(String(format: "%s (%@) (0x%lx)", name, _typeName(type, qualified: true), offset))
            return true
        }      
        print("===")
        ...
        print(_typeName(_typeByName("7SwiftUI19BarAppearanceBridgeC")!, qualified: true))
        _forEachField(of: _typeByName("7SwiftUI19BarAppearanceBridgeC")!, options: [.classType]) { name, offset, type, kind in
            print(String(format: "%s (%@) (0x%lx)", name, _typeName(type, qualified: true), offset))
            return true
        }      
        print("===")
        
        print(_typeName(_typeByName("7SwiftUI14OrnamentBridgeCyAA5ColorVG")!, qualified: true))
        _forEachField(of: _typeByName("7SwiftUI14OrnamentBridgeCyAA5ColorVG")!, options: [.classType]) { name, offset, type, kind in
            print(String(format: "%s (%@) (0x%lx)", name, _typeName(type, qualified: true), offset))
            return true
        }      
        print("===")
        ...
        print(_typeName(_typeByName("7SwiftUI22MRUIPreferenceExporterC")!, qualified: true))
        _forEachField(of: _typeByName("7SwiftUI22MRUIPreferenceExporterC")!, options: [.classType]) { name, offset, type, kind in
            print(String(format: "%s (%@) (0x%lx)", name, _typeName(type, qualified: true), offset))
            return true
        }      
        print("===")
