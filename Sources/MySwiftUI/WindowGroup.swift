...
public struct WindowGroup<Content> : Scene where Content : View {
    ...
    public nonisolated init(id: String, @ViewBuilder content: () -> Content) {
        assertUnimplemented()
    }
    ...
    @_disfavoredOverload public nonisolated init(_ title: Text, id: String, @ViewBuilder content: () -> Content) {
        assertUnimplemented()
    }
    ...
    @_disfavoredOverload public nonisolated init(_ title: Text, @ViewBuilder content: () -> Content) {
        assertUnimplemented()
    }
