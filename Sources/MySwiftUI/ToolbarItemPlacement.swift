...
public struct ToolbarItemPlacement {
    ...
    @safe public static let automatic = ToolbarItemPlacement(role: .automatic)
    
    @available(watchOS, unavailable)
    @safe public static let principal = ToolbarItemPlacement(role: .principal)
    
    @available(watchOS, unavailable)
    @safe public static let navigation = ToolbarItemPlacement(role: .navigation)
    
    @safe public static let primaryAction = ToolbarItemPlacement(role: .primaryAction(.automatic))
    ...
    @available(watchOS, unavailable)
    @safe public static let secondaryAction = ToolbarItemPlacement(role: .secondaryAction)
    
    @available(tvOS 18.0, *)
    @available(watchOS, unavailable)
    @safe public static let status = ToolbarItemPlacement(role: .status)
    
    @safe public static let confirmationAction = ToolbarItemPlacement(role: .confirmationAction)
    
    @safe public static let cancellationAction = ToolbarItemPlacement(role: .cancellationAction)
    
    @safe public static let destructiveAction = ToolbarItemPlacement(role: .destructiveAction)
    
    @available(iOS 15.0, macOS 12.0, *)
    @available(tvOS, unavailable)
    @available(watchOS, unavailable)
    @available(visionOS, unavailable)
    @safe public static let keyboard = ToolbarItemPlacement(role: .keyboard)
    ...
    @safe public static let navigationBarLeading: ToolbarItemPlacement = .topBarLeading
    ...
    @safe public static let navigationBarTrailing: ToolbarItemPlacement = .topBarTrailing
    ...
    @available(visionOS, unavailable)
    @usableFromInline
    @safe internal static let _title = ToolbarItemPlacement(role: .title)
    ...
    @available(watchOS, unavailable)
    @available(visionOS, unavailable)
    @safe public static let largeTitle = ToolbarItemPlacement(role: .largeTitle)
    ...
    @available(macOS, unavailable)
    @safe public static let bottomBar = ToolbarItemPlacement(role: .bottomBar)
    ...
    @available(tvOS, unavailable)
    @available(watchOS, unavailable)
    @safe public static let bottomOrnament = ToolbarItemPlacement(role: .bottomOrnament)
    ...
    @available(watchOS, unavailable)
    @available(visionOS, unavailable)
    @safe public static let subtitle = ToolbarItemPlacement(role: .subtitle)
    ...
    @available(watchOS, unavailable)
    @available(visionOS, unavailable)
    @safe public static let largeSubtitle = ToolbarItemPlacement(role: .largeTitle)
