struct AudioGroupPlaybackComponent : Component {
    @MainActor @preconcurrency static func __fromCore(_ coreComponent: __ComponentRef) -> AudioGroupPlaybackComponent {
        assertUnimplemented()
    }
