public struct AudioGroupPlaybackComponent : Component {
    @MainActor @preconcurrency public static func __fromCore(_ coreComponent: __ComponentRef) -> AudioGroupPlaybackComponent {
        assertUnimplemented()
    }
