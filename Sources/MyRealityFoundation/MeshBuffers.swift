...
extension MeshBuffers {
    ...
    @safe public static let positions: MeshBuffers.Semantic<SIMD3<Float>> = {
        assertUnimplemented()
    }()
    
    @safe public static let normals: MeshBuffers.Semantic<SIMD3<Float>> = {
        assertUnimplemented()
    }()
    
    @safe public static let tangents: MeshBuffers.Semantic<SIMD3<Float>> = {
        assertUnimplemented()
    }()
    
    @safe public static let bitangents: MeshBuffers.Semantic<SIMD3<Float>> = {
        assertUnimplemented()
    }()
    
    @safe public static let textureCoordinates: MeshBuffers.Semantic<SIMD2<Float>> = {
        assertUnimplemented()
    }()
    
    @safe public static let triangleIndices: MeshBuffers.Semantic<UInt32> = {
        assertUnimplemented()
    }()
