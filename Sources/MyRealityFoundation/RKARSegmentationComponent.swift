public struct RKARSegmentationComponent : Component {
    @MainActor @preconcurrency public static func __fromCore(_ coreComponent: __ComponentRef) -> RKARSegmentationComponent {
        assertUnimplemented()
    }
