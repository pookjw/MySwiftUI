public struct AcousticModelComponent : Component {
    @MainActor @preconcurrency public static func __fromCore(_ coreComponent: __ComponentRef) -> AcousticModelComponent {
        assertUnimplemented()
    }
