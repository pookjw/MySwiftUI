...
RE_EXTERN REComponentClassPtr _Nullable RESelectableSceneContentIdentifierGetComponentType(void) NS_SWIFT_NAME(getter:ComponentTypeClass.selectableSceneContentIdentifier());
