...
RE_EXTERN void REStructBuilderAddMemberCStyleArrayDataTypeWithTag(REStructBuilderRef, int, const char *, REIntrospectedDataType, int, int) NS_SWIFT_NAME(StructBuilder.addMemberCStyleArrayDataTypeWithTag(self:_:_:_:_:_:));
RE_EXTERN void REStructBuilderAddMemberArrayWithCountDataTypeWithTag(REStructBuilderRef, int, const char *, int, int, REIntrospectedDataType, int) NS_SWIFT_NAME(StructBuilder.addMemberArrayWithCountDataTypeWithTag(self:_:_:_:_:_:_:));
