...
RE_EXTERN BOOL RENetworkMarkComponentDirty(REComponent) NS_SWIFT_NAME(Component.networkMarkComponentDirty(self:));
RE_EXTERN REEntity REComponentGetEntity(REComponent) NS_SWIFT_NAME(getter:Component.entity(self:));
...
RE_EXTERN uint64_t REEntityGetLocalId(REEntity) NS_SWIFT_NAME(getter:Component.localId(self:));
RE_EXTERN void * _Nullable RECustomComponentGetObject(REComponent) NS_SWIFT_NAME(getter:Component.customComponentObject(self:));
