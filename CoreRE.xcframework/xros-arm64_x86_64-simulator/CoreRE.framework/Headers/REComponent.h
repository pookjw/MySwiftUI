...
RE_EXTERN REComponentTypeClass _Nullable RECustomComponentTypeCreate(const RECustomComponentTypeInfo *, BOOL) NS_SWIFT_NAME(ComponentTypeClass.createCustomComponentType(info:_:));
