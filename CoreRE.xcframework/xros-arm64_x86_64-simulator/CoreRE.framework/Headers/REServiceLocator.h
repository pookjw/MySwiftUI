...
RE_EXTERN REECSManagerRef _Nullable REServiceLocatorGetECSService(REServiceLocatorRef) NS_SWIFT_NAME(getter:ServiceLocator.ecsService(self:));
...
RE_EXTERN REPhysicsSimulationServiceRef _Nullable REServiceLocatorGetPhysicsSimulationService(REServiceLocatorRef) NS_SWIFT_NAME(getter:ServiceLocator.physicsSimulationService(self:));
