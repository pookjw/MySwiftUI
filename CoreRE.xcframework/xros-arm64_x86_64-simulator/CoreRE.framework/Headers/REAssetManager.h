...
RE_EXTERN void REAssetManagerPreloadVideoAssetOnce(REAssetManagerRef, REAssetRef, REVideoPlayerImmersiveViewingMode) NS_SWIFT_NAME(AssetManager.preloadVideoAssetOnce(self:_:_:));
