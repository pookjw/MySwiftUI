...
RE_EXTERN REComponentTypeClass _Nullable RESelectableSceneContentIdentifierGetComponentType(void) NS_SWIFT_NAME(getter:ComponentTypeClass.selectableSceneContentIdentifier());
